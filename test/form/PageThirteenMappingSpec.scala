...
class PageThirteenMappingSpec extends BaseSpec:

  import TestData.*

  "PageThirteenForm" should {
    "successfully bind to a full complement of valid form data" in {
      val form = bind(baseData)

      doesNotContainErrors(form)
    }

    "successfully bind to a full complement of valid just being no improvements or alterations" in {
    ...
    "return a required error when no value for whether work was required is entered" in {
    ...
    "not throw errors if no improvements are selected, and the other fields exist" in {
    ...
    "return a required error when no value for alterations and improvements is selected in the form data" in {
    ...
    "return an error and not bind when no value for any of the details for the alterations or improvements is input" in {
    ...
    "return an error and not bind when no value for the cost of alterations or improvements is input" in {
    ...
    "return an error and not bind when no value for the alterationType of alterations or improvements is input" in {
    ...
    "return an error and not bind when no value for the date of alterations or improvements is input" in {
    ...
    "return an error and not bind when multiple alterations are entered and one is missing the alterationType" in {
