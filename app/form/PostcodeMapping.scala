...
object PostcodeMapping {
  ...
  val postcodeRegex: Regex = """^[A-Z]{1,2}[0-9][A-Z0-9]? ?[0-9][A-Z]{2}$""".r

  def postcodeFormatter(missingError: String = "postcode.missing", formatError: String = "postcode.format"): Formatter[String] = new Formatter[String] {
