...
object Formats:
  ...
  private def namedEnumFormatterWithKeys[T <: NamedEnum](named: NamedEnumSupport[T], missingCodes: Map[String, String]): Formatter[T] =
    new Formatter[T]:
  ...
  implicit val notReviewRentFixedTypeFormat: Formatter[NotReviewRentFixedType] =
    namedEnumFormatter(NotReviewRentFixedTypes, Errors.whoWasTheRentFixedBetweenRequired)
  implicit val rentSetByTypesFormat: Formatter[RentSetByType]                  = namedEnumFormatter(RentSetByTypes, Errors.isThisRentRequired)

  implicit val responsibleTypesFormat: Formatter[ResponsibleType] = namedEnumFormatterWithKeys(
    ResponsibleTypes,
    Map(
