...
case class IncentivesAndPayments(
  rentFreePeriod: Boolean,
  rentFreePeriodDetails: Option[FreePeriodDetails],
...
case class CapitalDetails(capitalSum: BigDecimal, paymentDate: RoughDate)
