...
label.add.steppedRent=Ychwanegu rhent gris arall
...
propertyTypes.help=Er enghraifft, warws manwerthu, gweithdy, bwyty, tir
label.occupierTypes=Pwy yw deiliad yr eiddo?
occupierType.help=Os ydych yn sefydliad anfasnachol fel menter gymunedol, ymddiriedolaeth neu elusen, dewiswch "cwmni"
...
label.occupierCompanyContact=Enw''r cyswllt
label.firstOccupationDate=Pryd wnaethoch chi / gwnaethon nhw feddiannu''r eiddo am y tro cyntaf?
...
hint.landlordConnect=Busnes neu gysylltiad arall e.e. efallai eich bod chi/eich cleient a''r landlord yn bartneriaid busnes; neu efallai bod y cwmni sy''n rhentu''r eiddo yn gwmni daliannol neu''n is-gwmni i''r landlord.
...
label.writtenAgreement.leaseAgreementHasBreakClause=A geir cymal torri?
...
help.steprent.dateto=Er enghraifft, 12 3 2011
...
#SECTION 8
###############################
section8.heading=Sut y cafodd eich rhent ei osod, os nad trwy adolygiad
section8.heading.agent=Sut y cafodd rhent eich cleient ei osod, os nad trwy adolygiad?
...
hint.livingAccomodation=Er enghraifft, fflat uwchben siop neu lety gofalwr
label.landOnly=A oedd eich rhent yn seiliedig ar ddefnydd tir yn unig?
label.landOnly.agent=A oedd rhent eich cleient yn seiliedig ar ddefnydd tir yn unig?
hint.landOnly=Er enghraifft, nid oes adeiladau ar safle, neu gwnaethoch godi eich adeilad eich hun
label.shellUnit=A oedd eich rhent yn seiliedig ar adeilad gwag (cragen) heb unrhyw osodiadau a ffitiadau?
label.shellUnit.agent=A oedd rhent eich cleient yn seiliedig ar adeilad gwag (cragen) heb unrhyw osodiadau a ffitiadau?
...
label.ndrDetails=Swm bob blwyddyn a gaiff ei gynnwys yn y rhent heb gynnwys TAW
label.waterCharges=A yw taliadau dŵr wedi''u cynnwys yn y rhent?
label.includeWaterChargesDetails=Manylion gwasanaethau
label.waterChargesCost=Swm bob blwyddyn a gaiff ei gynnwys yn y rhent heb gynnwys TAW
label.includedServices=Ydy''r gost o wasanaethau wedi''i chynnwys yn eich rhent? Os felly, dywedwch pa rai
...
label.includedServicesDetails.chargeCost=Swm bob blwyddyn a gaiff ei gynnwys yn y rhent heb gynnwys TAW
...
info.responsibilitiesAndCosts.paying=Mae talu''n golygu bod yn gyfrifol am y gost hyd yn oed os yw''r landlord yn trefnu taliad drwy ddefnyddio arian y tenant (drwy dâl gwasanaeth).
...
hint.propertyAlterations=Dywedwch am unrhyw waith adeiladu neu welliannau (e.e ffitio allan cychwynnol, trwsio mawr, ail-wampio, estyniadau, dymchwel, lloriau mezzanine) Ticiwch ''Na'' lle dechreuodd y prydles mwy na 15 mlynedd yn ol os gwewch yn dda.
...
userType.ownerOccupier=Y Perchennog-ddeiliad
...
leaseAgreementTypes.verbal= Dim cytundeb, neu un nad yw''n ysgrifenedig
...
reviewIntervalType.every3Years=Pob 3 blynedd
reviewIntervalType.every5Years=Pob 5 mlynedd
reviewIntervalType.every7Years=Pob 7 mlynedd
...
rentSetByTypes.newLease=prydles neu gytundeb newydd
rentSetByTypes.renewedLease=prydles a adnewyddwyd
rentSetByTypes.leaseback=trafodiad gwerthu ac adlesu
rentSetByTypes.surrender=ildio ac adnewyddu
...
rentBaseTypes.indexation=Mynegio
...
rentBasisType.indexation=Mynegio
...
hint.if0thenenter1=Os nad oedd cost, rhowch swm 0 yma gan ddweud paham yn y disgrifiad o''r gwaith a wnaed uchod (e.e fe wnaethoch y gwaith eich hunan) os gwelwch yn dda
